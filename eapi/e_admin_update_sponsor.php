...
if ($sponsor_id == '') {
    echo json_encode(array("ResponseCode" => "404", "Result" => "false", "ResponseMsg" => "Sponsor not found"));
    return;
}
...
try {
    ...
    $result = $eventmedia->eventupdateData_Api($category_data, $table_name, "where id = $sponsor_id");
    if ($result) {
        echo json_encode(array("ResponseCode" => "200", "Result" => "true", "ResponseMsg" => "Sponsor has been updated successfully."));
    }
} catch (Exception $e) {
