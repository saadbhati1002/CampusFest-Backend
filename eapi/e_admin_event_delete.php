...
if ($event_id == '') {
    echo json_encode(array("ResponseCode" => "404", "Result" => "false", "ResponseMsg" => "Event ID not found"));
    return;
}
...
try {
    ...
    $result = $eventmedia->eventDeleteData("where id = $event_id", $table_name);
    if ($result) {
        echo json_encode(array("ResponseCode" => "200", "Result" => "true", "ResponseMsg" => "Event deleted successfully."));
    }
} catch (Exception $e) {
